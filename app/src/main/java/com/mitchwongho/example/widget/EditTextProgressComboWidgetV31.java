 ...
 *
 */
public class EditTextProgressComboWidgetV31 extends FrameLayout {

    public final static String TAG = EditTextProgressComboWidgetV31.class.getSimpleName();
    ...
    public EditTextProgressComboWidgetV31(Context context) {
        this(context, null);
    }

    public EditTextProgressComboWidgetV31(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EditTextProgressComboWidgetV31(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        constructor(context);
    }

    @TargetApi(23)
    public EditTextProgressComboWidgetV31(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void constructor(@NonNull final Context context) {
        ...
        sources.observeOn(AndroidSchedulers.mainThread()).forEach(integer ->
            editText.setText(Integer.toString(integer))
        );
    ...
    public void setSources(@NonNull final Observable<Integer>... sources) {
        for (Observable source : sources) {
            source.subscribe(this.sources);
        }
    }
